...
<!--                <div id="shout"></div>-->
                ...
                <form action="shout.php" class="p-5 bg-light" method="post" name="shoutbox">
...
<!--                  </div>-->
                  <div class="form-group">
                    <label for="message">Message</label>
                      <textarea name="message" id="message" cols="30" rows="10" class="form-control message"></textarea>
                  </div>
                  <div class="form-group">
                    <input type="submit" id="submit" value="Submit" class="btn py-3 px-4 btn-primary">
                  </div>
